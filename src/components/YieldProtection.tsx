...
import { ShieldCheck, BarChart3, Loader2, Info, Zap, TrendingUp, Droplets, FlaskConical, Bug, Stethoscope, AlertTriangle, Coins, ArrowRight, Shield } from 'lucide-react';
import { getYieldProtectionAdvice } from '../services/gemini';
import { motion, AnimatePresence } from 'motion/react';
import { VoiceInput } from './VoiceInput';

export const YieldProtection: React.FC<{ language?: 'en' | 'te' | 'hi' }> = ({ language: initialLanguage = 'en' }) => {
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <VoiceInput 
              ...
              className="w-full bg-stone-50 border border-stone-100 p-5 rounded-3xl text-stone-900 outline-none focus:ring-2 focus:ring-orange-500/20 font-bold text-lg transition-all"
          ...
          <div className="space-y-2">
            ...
            <select 
              ...
              className="w-full bg-stone-50 border border-stone-100 p-5 rounded-3xl text-stone-900 outline-none focus:ring-2 focus:ring-orange-500/20 font-bold text-lg transition-all appearance-none"
            >
          ...
          >
            ...
            <div className="bg-white p-8 rounded-[3rem] card-shadow border border-stone-100 space-y-8">
              ...
              <div className="p-8 bg-stone-900 rounded-[2.5rem] text-white flex flex-col items-center justify-center text-center gap-4 relative overflow-hidden">
                ...
                <p className="text-sm font-bold leading-relaxed opacity-90">{result.yieldPrediction}</p>
              </div>
